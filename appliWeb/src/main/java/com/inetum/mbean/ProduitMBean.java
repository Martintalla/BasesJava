...
public class ProduitMBean {
	...
	static {
		...
		var listeaccessoires = new ArrayList<Produit>();
		listeaccessoires.add(new Produit("Acc1" , "chevrolet" , 5000.0 , "VOITURE"));
		listeaccessoires.add(new Produit("Acc1" , "peugeot" , 20000.0 , "VOITURE"));
		mapCategorieProduits.put("VOITURE", listeaccessoires);
	}
	//Pour varaiante avec bouton déclenchement
...
//	public void onSelectinnerCategorie(ValueChangeEvent event);
	...
	public ProduitMBean() {
		...
		categoriesSelectionnables.add("VOITURE");
